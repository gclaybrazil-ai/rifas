...
// Check TESTE1774257393
$pix_id = "TESTE1774257393";
$ch2 = curl_init("https://pix.api.efipay.com.br/v2/gn/pix/enviados/id-envio/$pix_id");
...
$res2 = curl_exec($ch2);
echo "STATUS TESTE1774257393: " . $res2 . "\n";
?>
