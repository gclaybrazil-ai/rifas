...
<body class="min-h-screen flex items-center justify-center p-6 overflow-hidden">
    ...
    <div class="max-w-2xl w-full text-center relative z-10">
        ...
        <div class="relative mb-6 floating">
            <img src="frontend/png/maintenance_illustration_1773625003308.png" alt="Manutenção"
                class="mx-auto w-48 object-contain drop-shadow-[0_0_30px_rgba(99,102,241,0.4)] rounded-3xl">
        </div>
        ...
        <div class="glass rounded-[2.5rem] p-10 md:p-14 relative overflow-hidden">
            ...
            <span
                class="inline-block px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-[10px] font-bold uppercase tracking-[0.2em] mb-6">
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-4">
                <div
                    class="w-full md:w-auto px-8 py-4 bg-white text-gray-900 font-bold rounded-2xl shadow-xl hover:scale-105 transition-transform cursor-default">
                    Voltamos em breve
                </div>
                <a href="https://wa.me/5521981577453" target="_blank"
                    class="w-full md:w-auto px-8 py-4 glass text-white font-bold rounded-2xl hover:bg-white/10 transition-colors flex items-center justify-center gap-2">
