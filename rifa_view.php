...
<head>
    ...
    <title>$UPER$ORTE - Rifa Online</title>
...
<body class="bg-gray-100 text-gray-800 font-sans pb-32">
    ...
    <main class="max-w-md md:max-w-2xl mx-auto mt-6 px-4 bg-white rounded-xl shadow p-6 border border-gray-100 mb-10">
        <div class="text-center mb-6">
            ...
            <div id="edition-badge" class="hidden mt-2">
                <span
                    class="bg-purple-50 text-purple-600 text-[10px] md:text-xs px-3 py-1 rounded-full font-bold uppercase tracking-wider">
        ...
        <!-- Trust & Footer Info -->
        <div class="mt-8 mb-6 text-center px-4">
            <div class="flex flex-col items-center gap-2 mb-8">
                <div class="flex items-center justify-center gap-2 text-[9px] font-bold text-gray-400 uppercase tracking-wider bg-gray-50 py-2.5 px-6 rounded-full border border-gray-100 w-full sm:w-auto">
                    <span>🔒</span> Site 100% seguro e protegido
                </div>
                <div class="flex flex-col sm:flex-row gap-2 w-full justify-center">
                    <div class="flex-1 flex items-center justify-center gap-2 text-[9px] font-bold text-gray-400 border border-gray-100 uppercase tracking-wider bg-gray-50 py-2.5 px-4 rounded-full shadow-sm whitespace-nowrap">
            ...
            <div class="flex justify-center gap-4 mb-4">
                <a href="termos.html" class="text-[10px] font-black text-gray-500 uppercase hover:text-gray-700 transition-colors">Termos de Uso</a>
                <span class="text-gray-300">|</span>
                <a href="privacidade.html" class="text-[10px] font-black text-gray-500 uppercase hover:text-gray-700 transition-colors">Política de Privacidade</a>
            </div>

            <p class="text-[8px] font-bold text-gray-400 uppercase tracking-widest leading-loose">
    ...
    <div id="cookie-banner" class="fixed bottom-24 left-4 right-4 md:left-auto md:right-8 md:max-w-sm bg-gray-900/95 backdrop-blur-md text-white p-6 rounded-[2rem] shadow-2xl z-40 border border-white/10 hidden transform translate-y-20 transition-transform duration-700 select-none">
        <div class="flex items-start gap-4">
            <div class="w-10 h-10 bg-[#00a650] rounded-2xl flex items-center justify-center shrink-0 shadow-lg shadow-[#00a650]/20">
                <span class="text-xl">🍪</span>
            </div>
            <div class="flex-1">
                <h4 class="text-sm font-black italic tracking-tight mb-1 text-white uppercase">Sua Privacidade</h4>
                <p class="text-[11px] text-gray-300 font-medium leading-relaxed mb-4">Usamos cookies para que sua experiência no $UPER$ORTE seja personalizada e segura. Aceita continuar navegando?</p>
                <div class="flex flex-col gap-2">
                    <button id="btn-accept-cookies" class="w-full bg-[#00a650] hover:bg-[#008c44] text-white font-black py-2.5 rounded-xl text-[10px] uppercase tracking-widest transition-all active:scale-95 shadow-md">Aceitar e Continuar</button>
                    <a href="privacidade.html" class="text-[9px] text-gray-400 font-bold uppercase hover:underline text-center">Ver Políticas</a>
                </div>
            </div>
        </div>
    </div>
